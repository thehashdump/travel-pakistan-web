				...
				<div className={Styles.filters}>
					...
					<div className={Styles.date}>
						...
						<div className={Styles.datePicker}>
							<span for="date" className={Styles.heading}>Check-In</span>
							<span className={Styles.dateString}>10.02.2023</span>
							<input name='date' type="date" style={{ display: 'none' }}/>
						</div>
					</div>
					<div className={Styles.date}>
						<svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" fill="currentColor" class="bi bi-calendar4" viewBox="0 0 16 16">
						...
						<div className={Styles.datePicker}>
							<span className={Styles.heading}>Check-Out</span>
							<span className={Styles.dateString}>10.02.2023</span>
						</div>
					</div>
